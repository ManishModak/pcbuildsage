...
import { fetchPersonalities, fetchPersonas } from "../lib/api";
import type { Personality, Persona } from "../lib/types";
    ...
    <section className="flex flex-col gap-6">
      <header className="flex flex-col gap-1">
        ...
        <p className="text-base text-text-secondary">
          Pick the build strategies you want compared and the tone the sage speaks in. Change these any time.
        </p>
      </header>

      <div className="flex flex-col gap-3">
        <h2 className="text-caption font-medium uppercase tracking-wide text-text-secondary">Build personas</h2>
      ...
      <div className="flex items-center justify-between border-t border-border pt-4">
        ...
        <Button iconRight={MessageSquare} onClick={onFinish} disabled={config.personas.length === 0}>
          Start building
        </Button>
      </div>
    </section>
