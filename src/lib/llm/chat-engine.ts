...
export function buildSystemPrompt(config: AppConfig): string {
  ...
  return [
    ...
    "Aim to allocate the user's budget effectively for the intended use case (e.g. balancing GPU/CPU and using modern platforms where budget permits) rather than leaving large portions unspent.",
