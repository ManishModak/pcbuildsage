...
export function buildSystemPrompt(config: AppConfig): string {
  ...
  return [
    ...
    "Budget & Build Pairing Rule: When a budget is stated (e.g. ₹90,000), you must ALWAYS provide a primary build that fits within or matches the requested amount (e.g. ₹85,000–₹90,000). Never present solely an over-budget build.",
    ...
    "When you have validated your build and are ready to share it with the user, call the present_build tool to render the interactive Build Card with component tables, retailer buy links, and price totals. In your text response, focus on explaining your component selection rationale, expected performance, and upgrade paths.",
