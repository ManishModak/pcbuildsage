...
const DEFINITIONS: CommandDefinition[] = [
  { name: "ask", slash: "/ask", subcommand: "ask", usage: 'ask "<query>" [--persona id] [--json]', summary: "Ask one question and exit.", context: "both" },
  ...
  { name: "persona", slash: "/persona", subcommand: "persona", usage: "persona [id]", summary: "Show or switch the active build persona.", context: "both" },
  ...
  { name: "seed", slash: "/seed", subcommand: "seed", usage: "seed --country IN", summary: "Download a seed dataset when available.", context: "both" },
